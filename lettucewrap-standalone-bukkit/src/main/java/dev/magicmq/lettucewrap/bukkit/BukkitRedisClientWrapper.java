 ...
 */
public class BukkitRedisClientWrapper extends RedisClientWrapper<JavaPlugin> {
     ...
     */
    public BukkitRedisClientWrapper(JavaPlugin owner, String host) {
        super(owner, host);
    }
     ...
     */
    public BukkitRedisClientWrapper(JavaPlugin owner, String host, int port) {
     ...
     */
    public BukkitRedisClientWrapper(JavaPlugin owner, String host, String password) {
     ...
     * @param password The password of the redis server, or null if there is no password
     */
    public BukkitRedisClientWrapper(JavaPlugin owner, String host, int port, String password) {
     ...
     */
    public BukkitRedisClientWrapper(JavaPlugin owner, String host, int port, String password, int database) {
     ...
     */
    public BukkitRedisClientWrapper(JavaPlugin owner, String host, int port, String password, int database, String... options) {
